...
TweenMax.fromTo(".product-features", .5, {y:280, opacity: 0}, {y:0, opacity: 1, delay: 0.5, ease:Back.easeOut});
TweenMax.fromTo(".arrow-up", 0.5, {y: 280, opacity: 0}, {y: 0, opacity: 1, delay: .5, ease:Back.easeOut});
